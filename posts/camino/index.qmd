  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption">
        <p>Factorization day!<br><small>Photo shared with the students' consent.</small></p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="camino-2.jpg" alt="Students solving diagnostic problems">
      <div class="carousel-caption">
        <p>Midterm Examination.<br><small>Photo shared with the students' consent.</small></p>
      </div>
    </div>
    <div class="carousel-item">
...
The long-term goal is not to grant access to the 25 students in the first cohort, or to whoever finds my videos. It is to remove the barrier itself, so that no one has to decide who gets to pursue higher education, and financing is never the limitation.
